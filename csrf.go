...
func PlaintextHTTPRequest(r *http.Request) *http.Request { _ = "STUB: not implemented"; return nil }

// unauthorizedhandler sets a HTTP 403 Forbidden status and writes the
// CSRF failure reason to the response.
func unauthorizedHandler(w http.ResponseWriter, r *http.Request) { _ = "STUB: not implemented"; return }
